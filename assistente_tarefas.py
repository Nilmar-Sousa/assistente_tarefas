...
def escutar_comando():
    ...
    with sr.Microphone() as fonte_audio:
        ...
        print("Olá, eu sou o assistente de tarefas, o que deseja?")        
        fala = reconhecedor.listen(fonte_audio, timeout=10, phrase_time_limit=10)
        try:
...
def executar_comando(acao, objeto):
    print("O seguinte comando foi executado:", acao, objeto)
        ...
        try:
            ...
            if comando:
                ...
                if valido:
                    ...
                    print("Não consegui interpretar o comando. Repita, por favor!")
